...
function moduleFor(route) {
  ...
  if (route === '/tee-times/') return module({ eyebrow:'Golf / Booking', title:'Clear external booking handoff', body:'The unified site explains the handoff while leaving the existing booking system untouched.', extra:process([['Review golf information','Visitors can understand the golf journey before booking.'],['Continue externally','The approved legacy booking URL remains the destination.'],['Return to Elkhorn','Unified navigation remains available before the external handoff.']]) });
...
const conversionMap = [
  ...
  ['https://www.elkhorngc.com/book-a-tee-time/', 'tee_time_intent'],
